...
New-AzResourceGroup -Name "ADLab" -Location "Canada Central"

# - - Create & setup networking on the "client" - -

[string]$userName = 'ADLabLocalAdmin'
[string]$userPassword = Get-AzKeyVaultSecret 
# Convert to SecureString
[securestring]$secStringPassword = ConvertTo-SecureString $userPassword -AsPlainText -Force
[pscredential]$credObject = New-Object System.Management.Automation.PSCredential ($userName, $secStringPassword)

New-AzVM -ResourceGroupName "ADLab" -Name "MemberServer" -Location "Canada Central" -Image Win2019Datacenter -Size "Standard_B1s" -VirtualNetworkName "ADLabVN" -SubnetName "ADLabSubnet" -Credential $credObject

#Create a public IP for the Member Server
New-AzPublicIpAddress -Name "ADLabPIP" -ResourceGroupName "ADLab" -AllocationMethod Static -Location "Canada Central"
...
[string]$userPassword = 'Luf2gdep%e*u8HY6#&pG'
# Convert to SecureString
[securestring]$secStringPassword = ConvertTo-SecureString $userPassword -AsPlainText -Force
[pscredential]$credObject2 = New-Object System.Management.Automation.PSCredential ($userName, $secStringPassword)

#Create DC1
New-AzVM -ResourceGroupName "ADLab" -Name "DC1" -Location "Canada Central" -Image Win2019Datacenter -Size "Standard_B2s" -VirtualNetworkName "ADLabVN"-SubnetName "ADLabSubnet" -Credential $credObject2
...
#Create the public IP for DC1 (nested RDP sessions from the client take too much RAM so each DC needs its own public IP)
New-AzPublicIpAddress -Name "ADLabPIP2" -ResourceGroupName "ADLab" -AllocationMethod Static -Location "Canada Central"
$PIP = Get-AzPublicIpAddress -Name ADLabPIP2
$vnet = Get-AzVirtualNetwork -Name "ADLabVN" -ResourceGroupName "ADLab"
$subnet = Get-AzVirtualNetworkSubnetConfig -Name "ADLabSubnet" -VirtualNetwork $vnet
$VM = Get-AzVm -Name "DC1" -ResourceGroupName "ADLab"
$NIC = Get-AzNetworkInterface -ResourceGroupName "ADLab" -Name "DC1"
$NIC | Set-AzNetworkInterfaceIpConfig -Name "DC1" -PublicIPAddress $PIP -Subnet $subnet
$NIC | Set-AzNetworkInterface
...
#Create DC2
New-AzVM -ResourceGroupName "ADLab" -Name "DC2" -Location "Canada Central" -Image Win2019Datacenter -Size "Standard_DS1_v2" -VirtualNetworkName "ADLabVN"-SubnetName "ADLabSubnet" -Credential $credObject3

#Create a public IP for the DC2 (nested RDP sessions from the client take too much RAM so each DC needs its own public IP)
New-AzPublicIpAddress -Name "ADLabPIP3" -ResourceGroupName "ADLab" -AllocationMethod Static -Location "Canada Central"
$PIP = Get-AzPublicIpAddress -Name ADLabPIP3
$vnet = Get-AzVirtualNetwork -Name "ADLabVN" -ResourceGroupName "ADLab"
$subnet = Get-AzVirtualNetworkSubnetConfig -Name "ADLabSubnet" -VirtualNetwork $vnet
$VM = Get-AzVm -Name "DC2" -ResourceGroupName "ADLab"
$NIC = Get-AzNetworkInterface -ResourceGroupName "ADLab" -Name "DC2"
$NIC | Set-AzNetworkInterfaceIpConfig -Name "DC2" -PublicIPAddress $PIP -Subnet $subnet
$NIC | Set-AzNetworkInterface
...
#Lastly, comment out the 'Join-ADDomain', add 'Get-WindowsFeature | Where-Object {$_.Name -like "RSAT"} | Install-WindowsFeature', and run 'Config the Client.ps1' again

#Lastly, RDP into the client
#username = ADLab\ADLabAdmin
#password = Luf2gdep%e*u8HY6#&pG
